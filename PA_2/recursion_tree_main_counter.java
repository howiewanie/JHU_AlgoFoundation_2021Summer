...
//This file is used to count time complexity of the main file
...
public class recursion_tree_main_counter{
	//require users to enter different components of a parameter one by one
	public static void main(String[] args) {
		int counter =0;
		System.out.println("This is to test recurssion tree program's time complexity");
		...
		if(operator2.equals("/")){
			...
			Parameter_DQ_counter.conquerExpand(3,parameterExtract(A,B,C,D),counter);}

		else if(operator2.equals("-")){
			System.out.println("The original function is:\n"+"("+A+")T(n"+operator2+"("+B+"))+"+"("+C+")"+"(n)^("+D+")");		
			System.out.println("Your recursive function is: Divide and Chip");
			Parameter_DC_counter.chipExpand(3,parameterExtract(A,B,C,D),counter);}
		...
		//create a list of rational for future extraction
